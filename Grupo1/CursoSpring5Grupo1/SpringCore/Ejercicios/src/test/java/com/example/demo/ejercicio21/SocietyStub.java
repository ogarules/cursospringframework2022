...
import com.example.demo.ejercicio21.models.Society;
...
public class SocietyStub {
	...
	public static Inventor createRudolfVirchow() {
		...
		Inventor inventor = new Inventor("Rudolf Carl Virchow", "Prussian");
	...
	public static Inventor createJosephSwan() {
		...
		Inventor inventor = new Inventor("Sir Joseph Swan", "British");
	...
	public static Inventor createNikolayPopov() {
		...
		Inventor inventor = new Inventor("Mihajlo Idvorski Pupin", "Russian");
	...
	public static Inventor createIgnazioPorro() {
		...
		Inventor inventor = new Inventor("Ignazio Porro", "Italian");
	...
	public static Inventor createPresident() {
		...
		Inventor inventor = new Inventor("Mihajlo Idvorski Pupin", "Serbian");
	...
	public static Inventor createAlbertEinstein() {
		...
		Inventor inventor = new Inventor("Albert Einstein", "German");
	...
	public static Inventor createMikhailKalashnikov() {
		...
		Inventor inventor = new Inventor("Mikhail Kalashnikov", "Russian");
	...
	public static Inventor createMichaelFaraday() {
		...
		Inventor inventor = new Inventor("Michael Faraday", "British");
	...
	public static Inventor createAnatolyAlexandrov() {
		...
		Inventor inventor = new Inventor("Anatoly Alexandrov", "Russian");
	...
	public static Inventor createEdwinHowardArmstrong() {
		...
		Inventor inventor = new Inventor("Edwin H. Armstrong", "American");
	...
	public static Inventor createBlaisePascal() {
		...
		Inventor inventor = new Inventor("Blaise Pascal", "French");
	...
	public static Inventor createCharlesBabbage() {
		...
		Inventor inventor = new Inventor("Charles Babbage", "English");
	...
	public static Inventor createBruceAmes() {
		...
		Inventor inventor = new Inventor("Bruce Ames", "American");

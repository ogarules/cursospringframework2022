package com.example.demo.practica30.parte2.controllers;
...
public class ContactController {
	...
	public String submitForm(Model model, @Valid @ModelAttribute("contactForm") Contact form, BindingResult result) {
	...
	public String successProcess(@ModelAttribute("contactForm") Contact form) {
